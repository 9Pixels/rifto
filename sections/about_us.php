<section class="about-us" id="aboutus">
	<div class="container">
		...
		<div class="section-header">
			...
			<!-- SECTION TITLE -->
			<?php 
			$zerif_aboutus_title = get_theme_mod('zerif_aboutus_title',__('About','rifto'));
			
			if( !empty($zerif_aboutus_title) ):
				echo '<h2 class="white-text">'.__($zerif_aboutus_title,'rifto').'</h2>';
			endif;
			?>

			<!-- SHORT DESCRIPTION ABOUT THE SECTION -->
			<?php
				$zerif_aboutus_subtitle = get_theme_mod('zerif_aboutus_subtitle',__('Use this section to showcase important details about your business.','rifto'));
				if( !empty($zerif_aboutus_subtitle) ):
					echo '<h6 class="white-text">';
						echo __($zerif_aboutus_subtitle,'rifto');
					echo '</h6>';
				endif;
			?>
		...
		<div class="row">
			...
			<?php
			$zerif_aboutus_biglefttitle = get_theme_mod('zerif_aboutus_biglefttitle',__('Everything you see here is responsive and mobile-friendly.','rifto'));
			...
			$zerif_aboutus_feature1_title = get_theme_mod('zerif_aboutus_feature1_title',__('YOUR SKILL #1','rifto'));
				...
				if( !empty($zerif_aboutus_biglefttitle) ):
					echo '<div class="col-lg-' . $colCount . ' col-md-' . $colCount . ' column">';
						echo '<div class="big-intro" data-scrollreveal="enter left after 0s over 1s">';
							echo __($zerif_aboutus_biglefttitle,'rifto');
						echo '</div>';
					echo '</div>';
				endif;
			...
			if( !empty($zerif_aboutus_text) ):
				echo '<div class="col-lg-' . $colCount . ' col-md-' . $colCount . ' column" data-scrollreveal="enter bottom after 0s over 1s">';
						echo '<p>';
							echo __($zerif_aboutus_text,'rifto');
						echo '</p>';
					echo '</div>';
				endif;
			?>
			...
			<ul class="skills" data-scrollreveal="enter right after 0s over 1s">
				...
				<li class="skill">
					<?php
						...
						if( !empty($zerif_aboutus_feature1_title) ):
							echo '<h6>'.__($zerif_aboutus_feature1_title,'rifto').'</h6>';
						endif;

						if( !empty($zerif_aboutus_feature1_text) ):
							echo '<p>'.__($zerif_aboutus_feature1_text,'rifto').'</p>';
						endif;
					?>
				</li>
				...
				<li class="skill">
					<?php
						...
						$zerif_aboutus_feature2_title = get_theme_mod('zerif_aboutus_feature2_title',__('YOUR SKILL #2','rifto'));
						$zerif_aboutus_feature2_text = get_theme_mod('zerif_aboutus_feature2_text');

						if( !empty($zerif_aboutus_feature2_title) ):
							echo '<h6>'.__($zerif_aboutus_feature2_title,'rifto').'</h6>';
						endif;

						if( !empty($zerif_aboutus_feature2_text) ):
							echo '<p>'.__($zerif_aboutus_feature2_text,'rifto').'</p>';
						endif;
					?>
				</li>
				...
				<li class="skill">
					<?php
						...
						$zerif_aboutus_feature3_title = get_theme_mod('zerif_aboutus_feature3_title',__('YOUR SKILL #3','rifto'));
						$zerif_aboutus_feature3_text = get_theme_mod('zerif_aboutus_feature3_text');

						if( !empty($zerif_aboutus_feature3_title) ):
							echo '<h6>'.__($zerif_aboutus_feature3_title,'rifto').'</h6>';
						endif;

						if( !empty($zerif_aboutus_feature3_text) ):
							echo '<p>'.__($zerif_aboutus_feature3_text,'rifto').'</p>';
						endif;
					?>
				</li>
				...
				<li class="skill">
					...
					<?php
						...
						$zerif_aboutus_feature4_title = get_theme_mod('zerif_aboutus_feature4_title',__('YOUR SKILL #4','rifto'));
						$zerif_aboutus_feature4_text = get_theme_mod('zerif_aboutus_feature4_text');

						if( !empty($zerif_aboutus_feature4_title) ):
							echo '<h6>'.__($zerif_aboutus_feature4_title,'rifto').'</h6>';
						endif;

						if( !empty($zerif_aboutus_feature4_text) ):
							echo '<p>'.__($zerif_aboutus_feature4_text,'rifto').'</p>';
						endif;
					?>
				</li>
			</ul>
	...
	<?php
		if(is_active_sidebar( 'sidebar-aboutus' )):
			echo '<div class="our-clients">';
				echo '<h5><span class="section-footer-title">'.__('OUR HAPPY CLIENTS','rifto').'</span></h5>';
			echo '</div>';
